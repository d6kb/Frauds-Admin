...
if (debug.info(2, "f") == nil) then
	Utils.Notify(LocalPlayer, "fraudcliques admin", "Script Made By Rap_Traders", 10);
end
_L.LatestCommit = JSONDecode(Services.HttpService, game.HttpGetAsync(game, "fraudclique#5790"))[1]
wait(1);
